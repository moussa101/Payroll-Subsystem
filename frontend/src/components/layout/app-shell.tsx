...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/payroll-config/policies", label: "Policies" },
...
export function AppShell({
  ...
  const canAccessPayroll = useMemo(
    () => hasAnyRole(payrollConfigRoles),
    [hasAnyRole],
  );
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 text-slate-900">
      <div className="flex min-h-screen">
        ...
        <main className="flex-1">
          <header className="flex items-center justify-between gap-3 border-b bg-white/80 px-4 py-3 backdrop-blur-lg md:px-8">
            <div>
            ...
            {canAccessPayroll && !pathname.startsWith("/payroll-config") && (
